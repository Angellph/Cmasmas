...
using namespace std;
int main() {
    int res, Htrabajadas, bolita, edadEmeses, nivelDehemo, sexo, finn = 0, carta, num, suma = 0, numPc, pc, c;
    double Phora, Cdinero, dob, trip, impo, descuento, Cpagar, rangoMenor = 0, n1, n2, n3;
    do {
        cout<<"==========Menu de ejercicios==========\n";
        cout<<"Determinar el salario de un trabajador (1)\n";
        cout<<"Descuento de la tienda (2)\n";
        cout<<"Determinar si una persona tiene anemia o no (3)\n";
        cout<<"Determinar el numero medio de tres numeros diferentes (4)\n";
        cout<<"BlackJack (5)\n";
        cout<<"Elige: ";
        cin>>res;
